...
export function Navegation() {
    ...
    return (
        <div> 
            <nav className="bg-white dark:bg-primary-100 w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
            ...
            <div className="flex md:order-2">
                <button type="button" className="text-white dark:text-black bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-primary-400 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Get started</button>
            ...
            <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-primary-100 md:dark:bg-primary-100 dark:border-gray-700">
                    {/* <li>
                    ...
                    {links.map( link =>(
                        <li key={link.label} className="block py-2 pl-3 pr-4 rounded md:bg-transparent md:text-primary-400 md:p-0 md:dark:text-primary-200" aria-current="page">
                            <a href={link.route}>
                                {link.label}
                            </a>
                        </li>
